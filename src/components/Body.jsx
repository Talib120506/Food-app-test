...
let [userList, setUserList] = useState([userData]);
...
const fetchData = async () => {
  ...
  const dataPromise = await fetch('https://fake-json-api.mock.beeceptor.com/users');
  userList = await dataPromise.json();
  ...
  return (
      ...
      <div className="countDiv">
        ...
        <button className="filter-btn" onClick={() => {
          ...
          resList = restaurantList.filter(res => res.data.avgRating > 4.2)
          console.log(resList)
          setResList(resList)
          count=10000;
          setCount(count)
        ...
        <div className="userDetails">
          {
            userList.map(user => (
              <userDetails name={user.name} company={user.company} />
            ))
          }
